...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void _showFilterSheet(BuildContext context) {
    ...
    final filterLabels = [vm.l10n.catMeeting, vm.l10n.catLesson, vm.l10n.catProject, vm.l10n.catGeneral];
        ...
        builder: (ctx, setSheetState) => Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(vm.l10n.categoryFilter, style: AppTypography.labelCaps.copyWith(color: AppColors.primary, letterSpacing: 2)),
              if (_activeFilter != null)
                TextButton(
                  onPressed: () { setState(() => _activeFilter = null); Navigator.pop(ctx); },
                  child: Text(vm.l10n.clear, style: AppTypography.labelCaps.copyWith(color: AppColors.onSurfaceVariant)),
                ),
            ]),
  ...
  Widget build(BuildContext context) {
    return Consumer<AppViewModel>(
      builder: (context, vm, _) {
        final filteredHistory = vm.history.where((r) {
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${filteredHistory.length} ${vm.l10n.items}',
