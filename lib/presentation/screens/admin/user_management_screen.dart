...
class _UserManagementScreenState extends State<UserManagementScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<AuthViewModel>().fetchUsers();
    });
  }
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  final success = await context.read<AuthViewModel>().createUser(
                  ...
                  if (context.mounted) {
                    ...
                    if (success) {
                      ...
                      final err = context.read<AuthViewModel>().errorMessage;
                      ScaffoldMessenger.of(context).showSnackBar(
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  if (!formKey.currentState!.validate()) return;
                  final success = await context.read<AuthViewModel>().updateUserDetails(
                        user.id,
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isCurrentUser = user.id == authVm.currentUser?.id;
                            ...
                            children: [
                              ...
                              if (!isCurrentUser)
                                Switch(
                                  ...
                                  onChanged: (val) {
                                    authVm.updateUserDetails(user.id, isActive: val);
                                  },
                                ),
                              // Düzenle
                              IconButton(
                              ...
                              if (!isCurrentUser)
                                IconButton(
                                  ...
                                  onPressed: () => _confirmDelete(context, authVm, user),
                                ),
                            ],
                          ),
                        );
  ...
  void _confirmDelete(BuildContext context, AuthViewModel authVm, User user) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              final success = await authVm.deleteUser(user.id);
              if (ctx.mounted) {
                Navigator.pop(ctx);
